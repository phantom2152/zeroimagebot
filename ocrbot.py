...
def image_coversion(update ,context):
    ...
    update.message.reply_text('recived your image ! processing ... reply image with /img_to_txt to retrive image ')
...
def donate(update, context):
    keyboard = [
        [
            ...
            telegram.InlineKeyboardButton("upi",url="https://upayi.me/selvirajesh76@okhdfcbank/15"),
        ],
    ]

    reply_markup = telegram.InlineKeyboardMarkup(keyboard)
    update.message.reply_text("Thank you for comming forward ! , your donations makes our bot Alive and encourages us to give more updates in near future" , reply_markup=reply_markup)
...
def source_code(update, context):
    ...
    reply_markup = telegram.InlineKeyboardMarkup(keyboard)
    update.message.reply_text("Source code of @thezeroimagebot is available i github" , reply_markup=reply_markup)
...
def main() -> None:
    ...
    updater = Updater("1836635232:AAGk_RF5Jj5FjZ22myZq8LH9b_vEfpfPrUE")
